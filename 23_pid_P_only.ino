...
#define _EMA_ALPHA 0.38    // EMA weight of new sample (range: 0 to 1)
...
// PID parameters
#define _KP  2.6    // proportional gain
...
float volt_to_distance(int a_value)
{
  ...
  return 814 + -3.77 * a_value + 6.24 * 0.001 * pow(a_value, 2) + -3.64 * 0.000001 * pow(a_value, 3);
}
